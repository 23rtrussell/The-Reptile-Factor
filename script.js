...
var RandomFacts = ["Gecko's have over 1,500 spieces.", 
    ...
    "Hognose snakes are called that due to their nose looking like its been pointed up all the time.",
    "Rattlesnakes usually rattle to scare away and don't attack unless they have to.",
    "Some crocodiles are saltwater due to their gills ability to filter out the salt.",
    ...
    "John adams bought his son a pet alligator along with a tiger and a dog.",
    ...
    "Sea turtles are the ones that leave their eggs in the sand.",
